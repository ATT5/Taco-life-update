...
const About = () => {
  return (
    <section className="relative" id="about">
      ...
      {/* part 2️⃣ */}
      <div className="w-full h-screen bg-white text-green flex flex-col  md:px-24 max-md:pt-14 max-md:px-10  sticky top-0 z-10 pt-14 overflow-hidden">
        <img
          src={squiggle}
          alt="squiggle"
          className="relative  top-0 left-1/3 w-14 h-14 object-contain"
      ...
      {/* part  3️⃣*/}
      <div className="w-full h-screen bg-lightGreen text-green flex flex-col  md:px-24 max-md:pt-14 max-md:px-10  sticky top-0 z-10 pt-14 overflow-hidden ">
        <img
          src={squiggle}
          alt="squiggle"
          className="relative  top-0 left-1/3 w-14 h-14 object-contain"
      ...
      {/* part 4️⃣ */}
      <div className="w-full h-screen bg-green text-white flex flex-col  md:px-24 max-md:pt-14 max-md:px-10  sticky top-0 z-10 pt-14 overflow-hidden ">
        <img
          src={squiggle}
          alt="squiggle"
          className="relative  top-0 left-1/3 w-14 h-14 object-contain"
        ...
        <article className="max-lg:text-center flex max-lg:flex-col-reverse max-md:w-full h-500px">
          <p className=" text-lg font-thin font-rubik lg:w-2/3 tracking-widest leading-7 ">
          ...
          <img
            src={eating}
            alt="family"
            className="w-[600px] h-[600px] max-md:w-[90%] max-md:h-[90%] relative lg:top-[-5rem] max-lg:pb-6 "
          />
        </article>
      </div>
    </section>
