import { squiggle, wave, tacoMain } from "../assets";
  ...
  return (
    <section className="bg-green w-full  text-center text-white font-dela flex items-center flex-col ">
      ...
      <motion.img
        ...
        src={tacoMain}
        alt="tacos"
        className="w-[600px] h-[400px] relative z-10  bottom-8 max-sm:w-[400px] max-sm:h-[300px] object-contain mx-auto"
      />
      <motion.h2
      ...
      <img
        src={wave}
        alt="wave"
        className="w-full h-32  object-cover mt-28 lg:mt-40"
      />
    </section>
  );
};
