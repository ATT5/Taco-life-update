  ...
  return (
    <footer className=" bg-[#fff6f6]" id="footer">
      ...
      <div className=" bg-[#fff6f6]">
        ...
        <div className="h-[100vh] max-md:h-[600px] bg-pink"></div>
        <div className="bg-pink pt-32 pb-12 text-[#042f1a] flex md:justify-around max-lg:flex-col max-lg:items-center">
